...
@Builder
@AllArgsConstructor
@Schema(description = "Full study topic details including AI-generated outline")
public class StudyTopicResponse {
    ...
    @Schema(description = "AI-generated outline. Null if outline has not been generated yet.")
    ...
    @Schema(description = "Last update timestamp", example = "2024-01-01T09:00:00")
